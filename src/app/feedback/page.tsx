        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-10">
          ...
          <div className="flex items-center gap-5 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-2 text-lg">
                Collect customer reviews and let AI analyze sentiment, themes and insights instantly.
              </p>
          ...
          <div className="space-y-7">
            ...
            <button
              ...
              disabled={loading}
              className="group w-full overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-6 py-5 text-white shadow-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl disabled:opacity-70 disabled:cursor-not-allowed"
            >
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-bold">
                    {loading ? "Analyzing Feedback..." : "Analyze Feedback with AI"}
                  </span>
